...
function ResumeBuilderStartingPage() {
  return (
    <>
      <div
        className="w-full min-h-screen text-gray-900 flex bg-gray-100"
        style={{ backgroundColor: "rgb(240, 240, 242)" }}
      >
        {/* Sidebar */}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="max-w-xl">
                ...
                <p className="mt-4 text-lg text-gray-600">
                  Craft professional resumes effortlessly with artificial
                  intelligence. Get noticed and land your dream job faster.
                </p>
